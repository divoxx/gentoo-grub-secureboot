...
# Disk Identifiers
LINUX_ESP_UUID="${linux_esp_uuid}"
LINUX_ESP_PARTUUID="${linux_esp_partuuid}"
WINDOWS_ESP_UUID="${windows_esp_uuid}"

# LUKS / LVM
LUKS_UUID="${luks_uuid}"
LUKS_MAPPING_NAME="${luks_mapping}"
LUKS_ALLOW_DISCARDS="${luks_discards}"
LVM_VG="${lvm_vg}"
LVM_LV_ROOT="${lvm_lv_root}"
LVM_LV_SWAP="${lvm_lv_swap}"
